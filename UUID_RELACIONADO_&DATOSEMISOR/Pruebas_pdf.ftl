...
<pdf>
                        ...
                        <td  rowspan="3"  style="width: 30%;">
                            <#if certData?has_content>
                                <#if record.custbody_efx_fe_logosub?has_content>
                                    <img height="20%" src="${record.custbody_efx_fe_logosub}" style="float: left; margin: 10px" width="2in" />
                                </#if>
                            <#else>
                                <#if record.custbody_efx_fe_logosub?has_content>
                                    <#if subsidiary.logo@url?length != 0>
                                        <img height="20%" src="${subsidiary.logo@url}" style="float: left; margin: 10px" width="2in" />
                                    <#elseif companyInformation.logoUrl?length != 0>
                                        <img height="20%" src="${companyInformation.logoUrl}" style="float: left; margin: 10px" width="2in" />
                                    </#if>
                                </#if>
                            </#if>
    ...
    <body header="nlheader" header-height="8%" footer="nlfooter" footer-height="20pt" padding="0.2in 0.5in 0.25in 0.5in" size="Letter">
                ...
                <td colspan= "1">
                    <table  style="width:100%;">
                        ...
                        <#if customCompanyInfo?has_content>
                            ...
                            <tr>
                                <td font-size="8pt"><b >Domicilio fiscal:</b> ${record.custbody_efx_fe_dirsubs?replace(customCompanyInfo.legalname, "")?replace(rfc, "")}</td>
                            </tr>
                        </table>
                        <#else>
                          <#--  <tr>
                            ...
                            <tr>
                                <td font-size="8pt"><b >Domicilio fiscal:</b>
                                   ${companyInformation.mainaddress_text?replace(record.subsidiary.legalname, " ")}
                                </td>
                            </tr>
                        </table>
                        </#if>
        ...
        <table style="border-collapse: collapse; width: 100%; margin-top: 10px; padding: 0; border: 0px; border-color: #e3e3e3;">
                    ...
                    <tr>
                        <td colspan="8" style="border:1px;border-color: #e3e3e3; padding: 8px; text-align: center;">Documentos relacionados:</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="1" style=" border: 1px ; padding: 8px; text-align: left;border-color: #e3e3e3; ">Parcialidad</td>
                        <td colspan="1" style=" border: 1px ; padding: 8px; text-align: left;border-color: #e3e3e3; ">Importe del saldo anterior</td>
